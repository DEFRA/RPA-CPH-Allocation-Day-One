...
namespace CPHAllocationDayOne
{
    ...
    {
        private Lazy<global::CPHAllocationDayOne.WorkflowRunnerService> _workflowRunnerServiceLazy;
        ...
        public CodedWorkflow()
        {
            ...
            _workflowRunnerServiceLazy = new Lazy<global::CPHAllocationDayOne.WorkflowRunnerService>(() => new global::CPHAllocationDayOne.WorkflowRunnerService(this.services));
#pragma warning disable
            _connectionsManagerLazy = new Lazy<ConnectionsManager>(() => new ConnectionsManager(serviceContainer));
#pragma warning restore
        }

        protected global::CPHAllocationDayOne.WorkflowRunnerService workflows => _workflowRunnerServiceLazy.Value;
