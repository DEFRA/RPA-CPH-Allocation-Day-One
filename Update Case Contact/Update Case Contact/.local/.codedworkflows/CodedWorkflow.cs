...
namespace UpdateCaseContact
{
    public partial class CodedWorkflow : CodedWorkflowBase
    {
        private Lazy<global::UpdateCaseContact.WorkflowRunnerService> _workflowRunnerServiceLazy;
        ...
        public CodedWorkflow()
        {
            ...
            _workflowRunnerServiceLazy = new Lazy<global::UpdateCaseContact.WorkflowRunnerService>(() => new global::UpdateCaseContact.WorkflowRunnerService(this.services));
#pragma warning disable
            _connectionsManagerLazy = new Lazy<ConnectionsManager>(() => new ConnectionsManager(serviceContainer));
#pragma warning restore
        }

        protected global::UpdateCaseContact.WorkflowRunnerService workflows => _workflowRunnerServiceLazy.Value;
