...
namespace CPHAllocationDayOne
{
    public class WorkflowRunnerService
    {
        ...
        /// <summary>
        /// Invokes the Process/Process Subflows/OLD Check and Update Priority.xaml
        /// </summary>
        public void OLD_Check_and_Update_Priority(System.DateTime in_dateArrival)
        {
            var result = _services.WorkflowInvocationService.RunWorkflow(@"Process\Process Subflows\OLD Check and Update Priority.xaml", new Dictionary<string, object>{{"in_dateArrival", in_dateArrival}}, default, default, default, GetAssemblyName());
        }
        ...
        /// </summary>
		/// <param name="isolated">Indicates whether to isolate executions (run them within a different process)</param>
        public void OLD_Check_and_Update_Priority(System.DateTime in_dateArrival, System.Boolean isolated)
        {
            var result = _services.WorkflowInvocationService.RunWorkflow(@"Process\Process Subflows\OLD Check and Update Priority.xaml", new Dictionary<string, object>{{"in_dateArrival", in_dateArrival}}, default, isolated, default, GetAssemblyName());
        }
